                ...
                ? (function (t, e, i) {
                      return function s(n) {
                          ...
                          for (let {target: r} = n; r && r !== this; r = r.parentNode)
                              for (let a = o.length; a--; ) if (o[a] === r) return (n.delegateTarget = r), s.oneOff && $.off(t, n.type, e, i), i.apply(r, [n]);
                          return null;
                      };
                  })(t, i, s)
                : (function (t, e) {
        ...
        _addEventListeners() {
            this._config.keyboard && $.on(this._element, "keydown.bs.carousel", (t) => this._keydown(t)),
                "hover" === this._config.pause &&
                    ($.on(this._element, "mouseenter.bs.carousel", (t) => this.pause(t)), $.on(this._element, "mouseleave.bs.carousel", (t) => this.cycle(t))),
