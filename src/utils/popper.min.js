...
!(function (e, t) {
    ...
    function u(e, r, a) {
        ...
        return (
            (c || (!c && !a)) &&
                (("body" !== s(r) || l(u)) && (d = r !== n(r) && i(r) ? {scrollLeft: r.scrollLeft, scrollTop: r.scrollTop} : o(r)),
    ...
    function d(e) {
        var n = t(e),
            ...
            r = e.offsetHeight;
        return (
            1 >= Math.abs(n.width - o) && (o = n.width), 1 >= Math.abs(n.height - r) && (r = n.height), {x: e.offsetLeft, y: e.offsetTop, width: o, height: r}
        );
    }
    function m(e) {
    ...
    function B(e, n) {
        ...
        (o = k("number" != typeof (o = void 0 === (o = o.padding) ? 0 : o) ? o : A(o, N))),
            ...
            (c = M({reference: (s = t(e.elements.reference)), element: p, strategy: "absolute", placement: n})),
    ...
    function R(e) {
        ...
        return (
            ...
            l
                ...
                : Object.assign({}, o, (((t = {})[g] = s ? d + "px" : ""), (t[v] = m ? e + "px" : ""), (t.transform = ""), t))
        );
    }
    function H(e) {
        ...
        Q = {
            ...
            fn: function (e) {
                ...
                (o = void 0 === o || o),
                    ...
                    (e = {placement: x(t.placement), variation: L(t.placement), popper: t.elements.popper, popperRect: t.rects.popper, gpuAcceleration: e}),
                    null != t.modifiersData.popperOffsets &&
                        (t.styles.popper = Object.assign(
                            {},
                            t.styles.popper,
                            R(Object.assign({}, e, {offsets: t.modifiersData.popperOffsets, position: t.options.strategy, adaptive: o, roundOffsets: n}))
                        )),
                    null != t.modifiersData.arrow &&
                        (t.styles.arrow = Object.assign(
                            {},
                            t.styles.arrow,
                            R(Object.assign({}, e, {offsets: t.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: n}))
                        )),
